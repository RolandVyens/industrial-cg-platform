...
## Synced files
- `.agent/AGENT.md`
- `.agent/features/lightgroup-lobe-passes/scripts/check_feature4_gpu_flat_alpha_hole.py`
- `.agent/features/lightgroup-lobe-passes/scripts/check_feature4_lightgroup_subimages.py`
