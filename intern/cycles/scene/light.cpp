...
void LightManager::device_update_lights(DeviceScene *dscene, Scene *scene)
{
  ...
  for (Object *object : scene->objects) {
    ...
    if (light->is_portal) {
      ...
      klights[portal_index].shadow_color[0] = 0.0f;
      klights[portal_index].shadow_color[1] = 0.0f;
      klights[portal_index].shadow_color[2] = 0.0f;
    ...
    klights[light_index].shadow_color[0] = light->shadow_color.x;
    klights[light_index].shadow_color[1] = light->shadow_color.y;
    klights[light_index].shadow_color[2] = light->shadow_color.z;
