...
KERNEL_STRUCT_MEMBER(film, int, pass_lightgroup_diffuse)
KERNEL_STRUCT_MEMBER(film, int, pass_lightgroup_diffuse_direct)
KERNEL_STRUCT_MEMBER(film, int, pass_lightgroup_diffuse_indirect)
KERNEL_STRUCT_MEMBER(film, int, pass_lightgroup_glossy)
KERNEL_STRUCT_MEMBER(film, int, pass_lightgroup_glossy_direct)
KERNEL_STRUCT_MEMBER(film, int, pass_lightgroup_glossy_indirect)
KERNEL_STRUCT_MEMBER(film, int, pass_lightgroup_transmission)
KERNEL_STRUCT_MEMBER(film, int, pass_lightgroup_transmission_direct)
KERNEL_STRUCT_MEMBER(film, int, pass_lightgroup_transmission_indirect)
...
KERNEL_STRUCT_MEMBER(integrator, int, light_flags)
